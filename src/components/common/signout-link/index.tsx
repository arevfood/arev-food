    ...
    await onSignOut(undefined, {
      onSuccess: () => {
        showToast({
          ...
          message: 'You’ve been signed out. See you soon!',
          type: 'success',
        })
      },
      onError: () => {
      ...
      >
        <IonContent className="px-[20px]">
          <div className="px-5 py-8 w-full h-full flex items-center justify-center flex-col bg-white">
            <div>
              <div className="font-bold font-heading text-[22px] text-black mb-6">Logout</div>
              <div className="font-bold font-heading text-[18px] text-black">
                Are you sure you want to sign out?
              </div>
              <div className="font-paragraph text-[16px] text-black/40">
                We’ll log you out of your account. Any unsaved changes will be lost, so make sure
                everything is saved before proceeding.
              </div>
              <div className="mt-8">
