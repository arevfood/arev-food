import { IonHeader, IonToolbar, IonImg, IonBackButton, IonButtons } from '@ionic/react'
...
const MainHeader: React.FC<propTypes> = ({ transparent }) => {
  ...
  return (
    <IonHeader className="!shadow-none">
      <IonToolbar
        style={{
          '--background': !transparent ? 'var(--color-bg_color_1)' : 'transparent',
          '--border-width': '0',
        }}
        ...
        <IonButtons slot="start">
          {isHome ? (
            ...
            <div className="px-4">
              <IonBackButton
                defaultHref="/"
                icon={!transparent ? '/icons/arrow-left.svg' : 'icons/white-background-arrow.svg'}
                text={''}
