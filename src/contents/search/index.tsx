  ...
  return (
    <>
      ...
      />
        ...
        {!isSearch && (
            <>
                <IconTitle title={isSearchTab ? 'Popular Result' : 'All Disease'} icon="/icons/search-love.svg"/>
                <div className="grid grid-cols-2 gap-[16px] my-4">
                    ...
                    {!isSearchTab && (
                        diseasesData && diseasesData.map((disease, index) => {
                            return (
                                <DiseaseCard
                                    key={index}
                                    slug={disease.key}
        ...
        {isSearch && (
            <>
                ...
                {!isSearchTab && (
                    <div className={`grid gap-[16px] my-4 ${searchResultDisease.length === 0 ? 'grid-cols-1' : 'grid-cols-2'}`}>
