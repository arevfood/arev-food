  ...
  return (
    <IonReactRouter>
      <IonRouterOutlet>
        ...
        <Route exact path={'/'} render={() => <PrivateRoute component={<PagesHome />} />} />
        <Route exact path={'/search'} render={() => <PrivateRoute component={<PagesSearch />} />} />
        <Route
          exact
          path={'/favorite'}
        ...
        <Route
          ...
          render={() => <PrivateRoute component={<PagesSettingChangePassword />} />}
        />
        <Route
          exact
          path={'/setting/delete-account'}
          render={() => <PrivateRoute component={<PagesSettingDeleteAccount />} />}
        />
        <Route
          exact
          path={'/setting/menstrual-cycle'}
          render={() => <PrivateRoute component={<PagesSettingMenstrualCycle />} />}
        />
        <Route
          exact
          path={'/menstrual'}
