      ...
      {showSuggestions && (diseaseSuggestions.length > 0 || foodSuggestions.length > 0) && (
          <ul className="absolute w-full bg-white -mt-1 rounded-[6px] shadow-lg max-h-72 overflow-y-auto z-[5] py-2">
            {diseaseSuggestions.length > 0 && (
                <>
                  <li className="px-4 py-2 text-[0.913rem] text-black_color font-medium border-b border-black_color/[0.12] flex items-center">
                    Disease Suggestions <span className="text-black_color/[0.42] text-[0.813rem] ml-auto font-normal">{diseaseSuggestions.length} found.</span>
                  </li>
            ...
            {foodSuggestions.length > 0 && (
                <>
                  <li className={`px-4 py-2 text-[0.913rem] text-black_color font-medium border-b border-black_color/[0.12] flex items-center ${diseaseSuggestions.length > 0 ? 'border-t mt-4' : ''}`}>
                    Food Suggestions <span className="text-black_color/[0.42] text-[0.813rem] ml-auto font-normal">{foodSuggestions.length} found.</span>
                  </li>
